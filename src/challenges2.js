...
function triangleCheck(lineA, lineB, lineC) {
  if (lineA > Math.abs(lineB - lineC) && lineA < lineB + lineC) return true;
  if (lineB > Math.abs(lineA - lineC) && lineB < lineA + lineC) return true;
  if (lineC > Math.abs(lineB - lineA) && lineC < lineB + lineA) return true;
  return false;
}
